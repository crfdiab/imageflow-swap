    ...
    <header className={cn("w-full border-b border-border/40 backdrop-blur-sm sticky top-0 z-50", className)}>
      <div className="container mx-auto flex flex-col md:flex-row md:items-center md:justify-between py-4 px-4 sm:px-6">
        <div className="flex items-center justify-between">
          <Link href={languagePath("/")} className="flex items-center space-x-2" onClick={handleLinkClick}>
        ...
        <nav className="flex flex-col md:flex-row items-start md:items-center mt-4 md:mt-0 space-y-2 md:space-y-0 md:space-x-6">
          <div className="flex items-center space-x-6">
            <Link href={languagePath("/")} className="text-sm font-medium hover:text-primary transition-colors" onClick={handleLinkClick}>
              {t('common.tools')}
            </Link>
            <Link href={languagePath("/about")} className="text-sm font-medium hover:text-primary transition-colors" onClick={handleLinkClick}>
              {t('common.aboutUs')}
            </Link>
            <Link href={languagePath("/contact")} className="text-sm font-medium hover:text-primary transition-colors" onClick={handleLinkClick}>
              {t('common.contactUs')}
            </Link>
