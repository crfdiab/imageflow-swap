...
const ar: Translations = {
  ...
  pages: {
    home: {
      title: "تحويل الصور إلى صور أونلاين بصيغة مختلفة",
      description: "قم بعملية تحويل الصور الي صور أونلاين بسهولة وسرعة باستخدام أدواتنا المجانية والآمنة عبر المتصفح. حول بين تنسيقات الصور المختلفة وعالج حتى 50 صورة في المرة الواحدة دون الحاجة إلى التحميل - يتم كل التحويل مباشرة في متصفحك لتحقيق أقصى درجات الخصوصية والكفاءة.",
