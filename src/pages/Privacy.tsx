...
const Privacy = () => {
  ...
  useEffect(() => {
    ...
    metaDescription.setAttribute('content', t('pages.privacy.description'));
    ...
    canonicalLink.setAttribute('href', `https://convertify.click${languagePath('/privacy')}`);
  }, [languagePath, t]);
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose dark:prose-invert max-w-none">
            ...
            <h2>Contact Us</h2>
            <p>
              If you have any questions about this Privacy Policy, please <a href={languagePath('/contact')} className="text-primary hover:underline">contact us</a>.
            </p>
          </div>
        </div>
      </main>
